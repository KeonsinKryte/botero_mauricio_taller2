...
document.querySelector('#synthB').addEventListener('mousedown', function(){ synthB.triggerAttack('C4') })
document.querySelector('#synthB').addEventListener('mouseup', function(){ synthB.triggerRelease() })